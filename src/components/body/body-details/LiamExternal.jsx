...
const LiamExternalPage = () => {
  return (
    <div className="flex flex-col gap-0.5 p-1 text-gray-800 rounded-lg shadow-sm border border-black bg-[#ffffffe4]">
      <TileContentStyle label="PO" value="No" labelBold={true} />
      <TileContentStyle label="LA" value="No" labelBold={true} />
    </div>
  );
};
 
export default LiamExternalPage;