    ...
    >
      ...
      <motion.div variants={itemVariants}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-8 text-gray-800">
          ...
          <TileContentStyle label="ID Number" value="780801015342" />
          <TileContentStyle label="Height" value="0.00 cm" />
          <TileContentStyle label="E Policy Email ID" value="sksaims178@gmail.com" />
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6 text-gray-800">
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <TileContentStyle label="Address" value="NO 38, JALAN SERI AUSTIN 1/20, TAMAN SERI AUSTIN, 81100 JOHOR BHARU JOHOR" />
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <TileContentStyle label="Mobile" value="60123005948" />
            <TileContentStyle label="Home" value="60183066640" />
            <TileContentStyle label="Office" value="6076523764" />
            <TileContentStyle label="Email ID" value="sksaims178@gmail.com" />
          </div>
        </div>
      </motion.div>
    </motion.div>
