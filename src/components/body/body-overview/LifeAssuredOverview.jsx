  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-8 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Life Assured Details - TM1234452</h1>
      </motion.div>
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
          ...
          <div className="space-y-2">
            ...
            <TileContentStyle label="Email ID" value="laftest4@testmalaysia.com" labelBold={true} />
          </div>
        </div>
